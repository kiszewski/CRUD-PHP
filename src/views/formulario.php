<form action="#" method="post" class="form">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros['telefone'] ? 'is-invalid' : ''?>"
            type="text" name="telefone" id="telefone" value="<?= $user['telefone'] ?>">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros['email'] ? 'is-invalid' : ''?>"
            type="email" name="email" id="email" value="<?= $user['email'] ?>">
            <div class="invalid-feedback"><?=$erros['email']?></div>
        </div>
        <div class="form-group col-md-6">
            <label for="data_nascimento">Data de Nascimento</label>
            <input class="form-control <?=$erros['data_nascimento'] ? 'is-invalid' : ''?>"
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros['salario'] ? 'is-invalid' : ''?>"
            type="number" name="salario" id="salario" value="<?= $user['salario'] ?>">
            <div class="invalid-feedback"><?=$erros['salario']?></div>
        </div>
        <div class="form-group col-md-6">
            <label for="cidade">Cidade</label>
            <input class="form-control <?= $erros['cidade'] ? 'is-invalid' : ''?>"
            type="text" name="cidade" id="cidade" value="<?= $user['cidade'] ?>">
